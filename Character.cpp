...
void Character::initialize(int id, const char *imageFile, const char *matFile) {
...
void Character::SetTransform(mat4 m) {
  c_transform = m;
}
...
void Character::Display() {
  ...
  const char *vShader = R"(
    ...
    out vec2 uv;
    void main() {
      vec2 pts[] = vec2[4](vec2(0,-1), vec2(0,1), vec2(1,1), vec2(1,-1));
